...
// import { Download, Video, Music, Loader, CheckCircle, AlertCircle, PlayCircle, Eye, Calendar, User } from 'lucide-react';
...
//         endpoint = `${API_BASE}/download/playlist`;
...
//                     )}
//                     {videoInfo.duration && (
//                       <div className="flex items-center text-xl bg-white rounded-lg p-2 shadow-sm">
//                         <PlayCircle className="w-4 h-6 mr-2 text-red-500 flex-shrink-0" />
...
//                 className={`w-full font-bold py-4 px-6 rounded-lg transform transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 flex items-center justify-center space-x-2 ${downloading || !quality
